...
export default function Footer() {
  return (
    <footer className="relative bg-white/50 backdrop-blur-md border-t border-gray-200 py-12 px-6">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        <div className="flex flex-wrap justify-center gap-6 text-base text-gray-600">
          <a href="#features" className="hover:text-gray-900 hover:underline transition">Features</a>
          <a href="#how-it-works" className="hover:text-gray-900 hover:underline transition">How It Works</a>
          <a href="#terms" className="hover:text-gray-900 hover:underline transition">Terms</a>
          <a href="#privacy" className="hover:text-gray-900 hover:underline transition">Privacy Policy</a>
          <a href="#contact" className="hover:text-gray-900 hover:underline transition">Contact</a>
        </div>
        {/* Social Icons */}
        <div className="flex gap-5">
          {/* Twitter/X */}
          <a href="https://x.com/LoungeNavigator" target="_blank" rel="noopener noreferrer" aria-label="Twitter">
            <svg className="w-6 h-6 text-gray-600 hover:text-gray-900 transition-transform hover:scale-110" fill="currentColor" viewBox="0 0 24 24">
