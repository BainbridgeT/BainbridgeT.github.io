...
export default function HowItWorks() {
  return (
<section id="how-it-works" className="w-full bg-gray-50 py-20 px-6 relative overflow-hidden">
  {/* Section Header */}
    {/* ✅ Section Header goes here */}
    <div className="max-w-4xl mx-auto text-center mb-16 relative z-10">
    <p className="text-sm uppercase tracking-widest text-gray-500 font-semibold mb-2">How It Works</p>
    <h2 className="text-4xl md:text-5xl font-extrabold text-gray-900 mb-4">A Smarter Way to Lounge</h2>
  ...
  <div className="relative">
    {/* Vertical line: confined only to the steps */}
      ...
      {[
        ...
        return (
          <div key={i} data-aos="fade-up" className="relative flex flex-col md:flex-row items-center">
            ...
            <div className="absolute left-1/2 transform -translate-x-1/2 w-8 h-8 bg-gray-900 text-white rounded-full flex items-center justify-center font-bold text-sm shadow-md z-10 order-1 md:order-2">
              {i + 1}
            </div>
  ...
  {/* CTA (outside of vertical line container) */}
  <div className="text-center mt-16">
    <div className="inline-flex items-center gap-3 bg-white rounded-full px-8 py-4 shadow-md border border-gray-200">
      ...
      <a
        href="#download"
        className="bg-gray-900 text-white text-sm font-semibold px-6 py-2 rounded-full hover:bg-gray-800 transition-all duration-300 hover:scale-105"
      >
        Get Started
      </a>
    </div>
