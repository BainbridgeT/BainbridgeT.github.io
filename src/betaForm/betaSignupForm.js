...
export default function BetaSignupForm() {
  ...
  return (
<div
  className="relative min-h-screen bg-gradient-to-br from-[#f9fafb] via-white to-[#f9fafb] p-6 md:p-12 overflow-hidden"
  data-aos="fade-up"
>
  ...
  <div className="relative max-w-2xl mx-auto space-y-12">
    ...
    <header className="text-center">
      ...
      <p className="text-gray-500 text-xl mt-4 max-w-xl mx-auto">
        Be the first to experience LoungeNavigator and help shape the future of airport travel. We're launching a limited iOS beta, giving early users access to new features and the opportunity to help refine the experience before our full release.
      </p>
    </header>

    {/* Form Section */}
    <section className="bg-white/50 backdrop-blur-md rounded-4xl premium-shadow p-10 md:p-14 lg:p-16 transition hover:shadow-3xl">
      {submitted ? (
